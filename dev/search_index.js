...

{
    ...
    "title": "Orbit propagators",
    "category": "section",
    "text": "CurrentModule = SatelliteToolbox\nDocTestSetup = quote\n    using SatelliteToolbox\nendCurrently, there are four orbit propagators available: Two Body, J2, J4 and SGP4.  All coded in Julia (no external libraries required)."
},
...

{
    ...
    "title": "J2",
    "category": "section",
    "text": "This algorithm considers the perturbation terms up to J2 and the drag effects. The implementation available here was adapted from [1]."
},

{
    "location": "man/orbit/propagators/#J4-1",
    "page": "Orbit propagators",
    "title": "J4",
    "category": "section",
    "text": "This algorithm considers the perturbation terms J2, J2², and J4 and the drag effects. The implementation available here was adapted from [1]."
},
...

{
    ...
    "category": "section",
    "text": "All the propagators need to be initialized first using the API function init_orbit_proapgator. The functions signature for each algorithm can be seen as follows."
},

{
    "location": "man/orbit/propagators/#Initialization-of-Two-body,-J2,-and-J4-1",
    "page": "Orbit propagators",
    "title": "Initialization of Two body, J2, and J4",
    "category": "section",
    "text": "The orbit propagators two body, J2, and J4 can be initialized using three different methods.function init_orbit_proapgator(T, epoch::Number, f_0::Number, e_0::Number, i_0::Number, Ω_0::Number, ω_0::Number, f_0::Number)where:T is the type of the orbit propagator (Val{:twobody} for Two Body, Val{:J2} for J2, and Val{:J4} for J4).\nepoch: Initial orbit epoch [Julian Day].\na_0: Initial semi-major axis [m].\ne_0: Initial eccentricity.\ni_0: Initial inclination [rad].\nΩ_0: Initial right ascension of the ascending node [rad].\nω_0: Initial argument of perigee [rad].\nf_0: Initial true anomaly [rad].note: Note\nThe inputs are the mean orbital elements.function init_orbit_propagator(T, orb_0::Orbit)where:T is the type of the orbit propagator (Val{:twobody} for Two Body, Val{:J2} for J2, and Val{:J4} for J4).\norb_0: Initial orbital elements (see Orbit).function init_orbit_propagator(T, tle::TLE)where:T is the type of the orbit propagator (Val{:twobody} for Two Body, Val{:J2} for J2, and Val{:J4} for J4).\ntle: TLE that will be used to initialize the propagator (see TLE).There are some optional parameters that depend on the orbit propagator type that can be used to customize the algorithm. Those options are listed as follows:Two Bodyμ: Standard gravitational parameter of the central body [m³/s²] (Default = m0).J2 Orbit Propagatordn_o2: First time derivative of mean motion divided by 2 [rad/s²] (Default = 0).\nddn_o6: Second time derivative of mean motion divided by 6 [rad/s³] (Default = 0).\nj2_gc: J2 orbit propagator gravitational constants (see J2_GravCte) (Default = j2_gc_wgs84).warning: Warning\nThe two first options are not available when the TLE is used because this information is provided by the TLE.J4 Orbit Propagatordn_o2: First time derivative of mean motion divided by 2 [rad/s²] (Default = 0).\nddn_o6: Second time derivative of mean motion divided by 6 [rad/s³] (Default = 0).\nj4_gc: J4 orbit propagator gravitational constants (see J4_GravCte) (Default = j4_gc_wgs84).warning: Warning\nThe two first options are not available when the TLE is used because this information is provided by the TLE."
},

{
    "location": "man/orbit/propagators/#Initialization-using-the-angular-velocity-1",
    "page": "Orbit propagators",
    "title": "Initialization using the angular velocity",
    "category": "section",
    "text": "If the orbit is defined in terms of the angular velocity (mean motion) instead of the semi-major axis, then it is possible to use the function angvel_to_a to convert:function angvel_to_a(n::Number, e::Number, i::Number, pert::Symbol = :J2)It computes the semi-major axis that will provide an angular velocity n [rad/s] in an orbit with eccentricity e and inclination i [rad], using the perturbation terms specified by the symbol pert.Notice that the angular velocity n is related to the nodal period, i.e. the time between two consecutive passages by the ascending node.pert can be::J0: Consider a Keplerian orbit.\n:J2: Consider the perturbation terms up to J2.\n:J4: Consider the perturbation terms J2, J4, and J2².If pert is omitted, then it defaults to :J2."
},

{
    "location": "man/orbit/propagators/#Initialization-of-SGP4-1",
    "page": "Orbit propagators",
    "title": "Initialization of SGP4",
    "category": "section",
    "text": "The SGP4/SDP4 propagator is meant to be used together with a TLE. Hence, the initialization using user-defined orbital elements is not available through the API. If this is really required, then the user must access the low-level function sgp4_init.The API function to initialize the SGP4 using a TLE is:function init_orbit_propagator(T, tle::TLE, sgp4_gc::SGP4_GravCte = sgp4_gc_wgs84)where:T must be Val{:sgp4};\ntle: TLE that will be used to initialize the propagator (see TLE).\nsgp4_gc: Gravitational constants (see SGP4_GravCte) (Default = sgp4_gc_wgs84)."
},

{
    ...
    "title": "Propagation",
    "category": "section",
    "text": "After the orbit propagator is initialized, the orbit can be propagated by the API functions propagate!, propagate_to_epoch!, and step!.The function propagate! has two signature. The first one isfunction propagate!(orbp, t::Number) where Tin which the orbit will be propagated by t [s] from the orbit epoch, which is defined in the initialization and is never changed. This function returns a tuple with three values:The mean Keplerian elements represented in the inertial reference frame encapsulated in an instance of the structure Orbit [SI units].\nThe position vector represented in the inertial reference frame [m].\nThe velocity vector represented in the inertial reference frame [m].The second signature of propagate! is:function propagate!(orbp, t::AbstractVector) where Twhere the orbit will be propagated for every value in the vector t [s], which is a number of seconds from the orbit epoch. In this case, an array of tuples with be returned with each element equivalent to that described for the first case.The function propagate_to_epoch! also have two signatures similar to propagate!:function propagate_to_epoch!(orbp, JD::Number) where T\nfunction propagate_to_epoch!(orbp, JD::AbstractVector) where TIt also returns the same information. However, the input argument JD is an epoch [Julian Day] to which the orbit will be propagated instead of the number of seconds from the orbit epoch.warning: Warning\nThe conversion from Julian Day to seconds that propagate_to_epoch! must perform can introduce numerical errors.The step! function has the following signature:function step!(orbp, Δt::Number)where the orbit is propagated by Δt [s] from the last propagation instant. This function returns the same information of the first signature of propagate! method.In all cases, the structure orbp is modified by updating the orbit elements related to the last propagation instant.note: Note\nAll the algorithms can be used to propagate the orbit forward or backward in time."
},
...

{
    ...
    "category": "constant",
    "text": "Union of all Earth-Centered Earth-Fixed (ECEF) frames supported by the IAU-76/FK5 theory.\n\n\n\n\n\n"
},

{
    "location": "lib/library/#SatelliteToolbox.T_ECEFs_IAU_2006",
    "page": "Library",
    "title": "SatelliteToolbox.T_ECEFs_IAU_2006",
    "category": "constant",
    "text": "Union of all Earth-Centered Earth-Fixed (ECEF) frames supported by IAU-2006/2010 theory.\n\n\n\n\n\n"
},

{
    ...
    "category": "constant",
    "text": "Union of all Earth-Centered Inertial (ECI) frames supported by the IAU-76/FK5 theory.\n\n\n\n\n\n"
},

{
    "location": "lib/library/#SatelliteToolbox.T_ECIs_IAU_2006",
    "page": "Library",
    "title": "SatelliteToolbox.T_ECIs_IAU_2006",
    "category": "constant",
    "text": "Union of all Earth-Centered Inertial (ECI) frames supported by IAU-2006/2010 theory.\n\n\n\n\n\n"
},

{
    ...
    "category": "constant",
    "text": "Union of all of date Earth-Centered Inertial (ECI) frames supported by the IAU-76/FK5 theory.\n\n\n\n\n\n"
},
...
{
    "location": "lib/library/#SatelliteToolbox.dlegendre_conventional-Union{Tuple{T}, Tuple{T,Integer}, Tuple{T,Integer,Integer}, Tuple{T,Integer,Integer,Bool}} where T<:AbstractFloat",
    "page": "Library",
    "title": "SatelliteToolbox.dlegendre_conventional",
    "category": "method",
    "text": "function dlegendre_conventional(ϕ::Number, n_max::Integer, m_max::Integer = -1, ph_term::Bool = false)\n\nCompute the first-order derivative of the conventional associated Legendre function P_n,m[cos(ϕ)] w.r.t. ϕ [rad]:\n\ndP_n,m[cos(ϕ)]\n--------------\n      dϕ\n\nThe maximum degree that will be computed is n_max and the maximum order is m_max. Notice that if m_max is higher than n_max or negative, than it is set to n_max.\n\nIf ph_term is set to true, then the Condon-Shortley phase term (-1)ᵐ will be included. If ph_term is not present, then it defaults to false.\n\nReturns\n\nA matrix with the first-order derivative of the Legendre associated functions P_n,m[cos(ϕ)].\n\n\n\n\n\n"
},
...
{
    "location": "lib/library/#SatelliteToolbox.dlegendre_fully_normalized-Union{Tuple{T}, Tuple{T,Integer}, Tuple{T,Integer,Integer}, Tuple{T,Integer,Integer,Bool}} where T<:AbstractFloat",
    "page": "Library",
    "title": "SatelliteToolbox.dlegendre_fully_normalized",
    "category": "method",
    "text": "function dlegendre_fully_normalized(ϕ::T, n_max::Integer, m_max::Integer = -1, ph_term::Bool = false) where T<:AbstractFloat\n\nCompute the first-order derivative of the Schmidt fully normalized associated Legendre function P_n,m[cos(ϕ)] w.r.t. ϕ [rad]:\n\ndP_n,m[cos(ϕ)]\n--------------\n      dϕ\n\nThe maximum degree that will be computed is n_max and the maximum order is m_max. Notice that if m_max is higher than n_max or negative, than it is set to n_max.\n\nIf ph_term is set to true, then the Condon-Shortley phase term (-1)ᵐ will be included. If ph_term is not present, then it defaults to false.\n\nReturns\n\nA matrix with the first-order derivative of the Legendre associated functions P_n,m[cos(ϕ)].\n\n\n\n\n\n"
},
...
{
    "location": "lib/library/#SatelliteToolbox.dlegendre_schmidt_quasi_normalized-Union{Tuple{T}, Tuple{T,Integer}, Tuple{T,Integer,Integer}, Tuple{T,Integer,Integer,Bool}} where T<:AbstractFloat",
    "page": "Library",
    "title": "SatelliteToolbox.dlegendre_schmidt_quasi_normalized",
    "category": "method",
    "text": "function dlegendre_schmidt_quasi_normalized(ϕ::T, n_max::Integer, m_max::Integer = -1, ph_term::Bool = false) where T<:AbstractFloat\n\nCompute the first-order derivative of the Schmidt quasi-normalized associated Legendre function P_n,m[cos(ϕ)] w.r.t. ϕ [rad]:\n\ndP_n,m[cos(ϕ)]\n--------------\n      dϕ\n\nThe maximum degree that will be computed is n_max and the maximum order is m_max. Notice that if m_max is higher than n_max or negative, than it is set to n_max.\n\nIf ph_term is set to true, then the Condon-Shortley phase term (-1)ᵐ will be included. If ph_term is not present, then it defaults to false.\n\nReturns\n\nA matrix with the first-order derivative of the Legendre associated functions P_n,m[cos(ϕ)].\n\n\n\n\n\n"
},
...
{
    "location": "lib/library/#SatelliteToolbox.legendre_conventional-Union{Tuple{T}, Tuple{T,Integer}, Tuple{T,Integer,Integer}, Tuple{T,Integer,Integer,Bool}} where T<:AbstractFloat",
    "page": "Library",
    "title": "SatelliteToolbox.legendre_conventional",
    "category": "method",
    "text": "function legendre_conventional(ϕ::T, n_max::Integer, m_max::Integer = -1, ph_term::Bool = false) where T<:AbstractFloat\n\nCompute the conventional associated Legendre function P_n,m[cos(ϕ)]. The maximum degree that will be computed is n_max and the maximum order is m_max. Notice that if m_max is higher than n_max or negative, than it is set to n_max.\n\nIf ph_term is set to true, then the Condon-Shortley phase term (-1)ᵐ will be included. If ph_term is not present, then it defaults to false.\n\nReturns\n\nA matrix with the Legendre associated functions P_n,m[cos(ϕ)].\n\n\n\n\n\n"
},
...
{
    "location": "lib/library/#SatelliteToolbox.legendre_fully_normalized-Union{Tuple{T}, Tuple{T,Integer}, Tuple{T,Integer,Integer}, Tuple{T,Integer,Integer,Bool}} where T<:AbstractFloat",
    "page": "Library",
    "title": "SatelliteToolbox.legendre_fully_normalized",
    "category": "method",
    "text": "function legendre_fully_normalized(ϕ::T, n_max::Integer, m_max::Integer = -1, ph_term::Bool = false) where T<:AbstractFloat\n\nCompute the fully normalized associated Legendre function P_n,m[cos(ϕ)]. The maximum degree that will be computed is n_max and the maximum order is m_max. Notice that if m_max is higher than n_max or negative, than it is set to n_max.\n\nIf ph_term is set to true, then the Condon-Shortley phase term (-1)ᵐ will be included. If ph_term is not present, then it defaults to false.\n\nReturns\n\nA matrix with the Legendre associated functions P_n,m[cos(ϕ)].\n\nRemarks\n\nThis algorithm was based on [1]. Our definition of fully normalized associated Legendre function can be seen in [2, p. 546]. The conversion is obtained by:\n\n             _                     -\n            |  (n-m)! . k . (2n+1)  |      k = 1 if m  = 0\nK_n,m = sqrt| --------------------- |,     k = 2 if m != 0\n            |         (n+m)!        |\n             -                     -\n_\nP_n,m = P_n,m * K_n,m,\n\n      _\nwhere P_n,m is the fully normalized Legendre associated function.\n\n\n\n\n\n"
},
...
{
    "location": "lib/library/#SatelliteToolbox.legendre_schmidt_quasi_normalized-Union{Tuple{T}, Tuple{T,Integer}, Tuple{T,Integer,Integer}, Tuple{T,Integer,Integer,Bool}} where T<:AbstractFloat",
    "page": "Library",
    "title": "SatelliteToolbox.legendre_schmidt_quasi_normalized",
    "category": "method",
    "text": "function legendre_schmidt_quasi_normalized(ϕ::T, n_max::Integer, m_max::Integer = -1, ph_term::Bool = false) where T<:AbstractFloat\n\nCompute the Schmidt quasi-normalized associated Legendre function P_n,m[cos(ϕ)]. The maximum degree that will be computed is n_max and the maximum order is m_max. Notice that if m_max is higher than n_max or negative, than it is set to n_max.\n\nIf ph_term is set to true, then the Condon-Shortley phase term (-1)ᵐ will be included. If ph_term is not present, then it defaults to false.\n\nReturns\n\nA matrix with the Legendre associated functions P_n,m[cos(ϕ)].\n\nRemarks\n\nThis algorithm was based on [3,4]. The conversion is obtained by:\n\n             _           -\n            |     (n-m)!  |    k = 1 if m  = 0\nK_n,m = sqrt| k. -------- |,   k = 2 if m != 0\n            |     (n+m)!  |\n             -           -\n\n=\nP_n,m = P_n,m * K_n,m,\n\n      =\nwhere P_n,m is the quasi-normalized normalized Legendre associated function.\n\n\n\n\n\n"
},
